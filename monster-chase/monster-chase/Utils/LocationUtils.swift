...
public struct LocationUtils {
    ...
    public static func chaseDistanceToPlayerLocation(chase: Chase, playerLocation: CLLocation) -> CLLocationDistance {
        let hintQuadrantCenterPoint = getRegularCentroid(points: chase.getQuadranHintCorners())
