//
//  CreateChaseMapViewController.swift
//  monster-chase
//
...
class CreateChaseMapViewController: UIViewController, CLLocationManagerDelegate, MKMapViewDelegate, UIGestureRecognizerDelegate, UISearchBarDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        if CLLocationManager.locationServicesEnabled() {
            ...
            let alertView = self.monsterAlertView(title: "Error", message: "Location services are disabled, please enable before trying again.")
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        do {
            ...
            print("CreateChaseMapViewController - viewWillApper(), failed to call refreshView()")
        }
    }
